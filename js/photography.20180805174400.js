...
r=function(){if(thresholdPassed()){dpi=window.devicePixelRatio;if($(window).width()>=1200){$('.js-25').attr('src', (dpi>1) ? ((dpi>2) ? 'images/pasted-image-159-2.png' : 'images/pasted-image-106-2.png') : 'images/pasted-image-53-2.png');
